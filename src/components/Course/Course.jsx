...
const Course = ({ course }) => {
    ...
    console.log('---', course);
    return (
        <div className='w-[312px] h-[420px] bg-white p-4 space-y-2'>
            <img src={image} alt="" />
            <h1 className=' text-lg font-semibold'>{course_name}</h1>
            <p className='text-[#1C1B1B99] h-[120px]'>{details}</p>
            <div className=''>
                <span className='text-[#1C1B1B99]'><span className=' inline-block'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <span className='text-[#1C1B1B99] ml-5'><span className=' inline-block'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <button className=' mt-2 btn rounded-lg text-white w-[280px] h-[40px] bg-[#2F80ED]'>Select</button>
